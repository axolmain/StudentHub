...
namespace StudentHub.Server.Areas.Identity.Pages.Account;
...
public class ExternalLoginModel : PageModel
{
    ...
    [ViewData] public string AssociateExistingAccount { get; set; } = "false";
        ...
        if (ModelState.IsValid)
        {
            ...
            else
            {
                ...
                if (ExistingUserToCheck != null)
                    ...
                    {
                        var PasswordNotSetError = new StringBuilder();
